...
class OWLTaskGroupServiceTest {
    ...
    void createTaskGroup() {
        // Arrange
        ModifyTaskGroupDto<ModifyOWLTaskGroupDto> dto = new ModifyTaskGroupDto<>("owl", TaskStatus.APPROVED, new ModifyOWLTaskGroupDto());
        ...
        // Assert
        assertEquals(dto.additionalData(), taskGroup);
    }

    @Test
    void createTaskGroupInvalidType() {
        // Arrange
        ModifyTaskGroupDto<ModifyOWLTaskGroupDto> dto = new ModifyTaskGroupDto<>("sql", TaskStatus.APPROVED, new ModifyOWLTaskGroupDto());
        OWLTaskGroupService service = new OWLTaskGroupService(null, null);
    ...
    void updateTaskGroup() {
        ...
        ModifyTaskGroupDto<ModifyOWLTaskGroupDto> dto = new ModifyTaskGroupDto<>("owl", TaskStatus.APPROVED, new ModifyOWLTaskGroupDto());
        OWLTaskGroupService service = new OWLTaskGroupService(null, null);
        var taskGroup = new OWLTaskGroup(TaskStatus.APPROVED);
    ...
    void mapToReturnData() {
        ...
        verify(ms).getMessage("defaultTaskGroupDescription", new Object[]{}, Locale.GERMAN);
        verify(ms).getMessage("defaultTaskGroupDescription", new Object[]{}, Locale.ENGLISH);
    }
